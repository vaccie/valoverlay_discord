...
<p align="center">
  <img src="website/assets/showcase.png" alt="Valorant Overlay Showcase" width="600">
</p>
...
1. Download the latest `ValorantOverlay.exe` from the [Releases](https://github.com/yourusername/valorant-overlay/releases) page.
...
Contributions, issues, and feature requests are welcome! Feel free to check [issues page](https://github.com/yourusername/valorant-overlay/issues).
